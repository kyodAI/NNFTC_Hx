...
class PlottableTrainer:
    def __init__(self):
        ...
        #     plt.plot(range(len(self.errors_history)), self.errors_history, color='red')
        #     plt.ylim([0, 2])
        #     return plt
        ...
        #     plt.plot(range(len(self.loss_gradient_history)), self.loss_gradient_history, color='orange')
        #     plt.ylim([0, 2])
        #     return plt
