...
from CoreDeepLearning.layers import Softmax, Sigmoid, Sign, Relu, Tanh, CheapTanh, Const, Mul, Sum, Wx, PlusBias, WxBiasLinear, Print, \
    MatrixWeight
import CoreDeepLearning.numerical_gradient
from CoreDeepLearning.loss import NLL, CrossEntropyLoss, ClaudioMaxNLL, SquaredLoss
from CoreDeepLearning.optim import SGD
from CoreDeepLearning.network import Seq, Par, Map, Identity
from CoreDeepLearning.trainers import MinibatchTrainer, OnlineTrainer
from CoreDeepLearning.utils import make_one_hot_target

# from layers import WxBiasLinear as Linear
from CoreDeepLearning.layers import Linear
