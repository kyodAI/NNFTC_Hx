...
from CoreDeepLearning.rnn.gru import GRU
from CoreDeepLearning.layers import Softmax
from CoreDeepLearning.loss import CrossEntropyLoss, NLL
from CoreDeepLearning.rnn.lstm import LSTM
from CoreDeepLearning.optim import SGD, AdaGrad, RMSProp
from CoreDeepLearning.utils import sliding_window, chunks
from CoreDeepLearning.rnn.vanilla_rnn import VanillaRNN
...
while True:
    for x_str, target_str in sliding_window(data, seq_length):
        ...
        window = list(zip(inputs_one_hot, targets_one_hot))
